...
namespace Raytracer.Collections
{
	public sealed class OrderedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary
	{
		private readonly OrderedDictionary m_PrivateDictionary;
	...
	internal sealed class OrderedDictionary : IDictionary
	{
